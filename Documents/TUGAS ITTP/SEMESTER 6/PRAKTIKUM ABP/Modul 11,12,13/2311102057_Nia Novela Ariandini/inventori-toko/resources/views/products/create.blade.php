...
<head>
    ...
    <title>Tambah Produk | Novela Stock</title>
    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 ml-64 bg-[#fcfdfe]">
            <header class="h-20 bg-white/80 backdrop-blur-md px-10 flex items-center justify-between border-b border-gray-100 sticky top-0 z-40">
                <div>
                    <h2 class="text-sm font-bold text-gray-800 uppercase tracking-wider">Tambah Produk Baru</h2>
                    <p class="text-[10px] text-gray-400 font-medium">Pak Cik & Aimar Stock / Produk / Tambah</p>
                </div>
            ...
            <div class="p-10 max-w-[900px]">
                <div class="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
                    <div class="p-8 border-b border-gray-50 bg-gray-50/30">
                        <h3 class="text-xl font-bold text-gray-800">Detail Informasi Produk</h3>
                        <p class="text-xs text-gray-400 font-medium mt-1">Pastikan data stok dan harga sudah sesuai dengan inventori fisik.</p>
                    </div>
                    ...
                    <form action="{{ route('products.store') }}" method="POST" class="p-8 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2 md:col-span-2">
                                <label class="text-[11px] font-bold text-gray-400 uppercase tracking-widest ml-1">Nama Produk Skincare</label>
                                <input type="text" name="nama" placeholder="Contoh: Brightening Serum Vitamin C" 
                                    class="w-full px-5 py-4 bg-gray-50 border border-gray-100 rounded-2xl text-sm font-medium transition-all" required>
                            </div>

                            <div class="space-y-2 md:col-span-2">
                                <label class="text-[11px] font-bold text-gray-400 uppercase tracking-widest ml-1">Deskripsi Produk</label>
                                <textarea name="deskripsi" rows="4" placeholder="Jelaskan manfaat atau kandungan utama produk..." 
                                    class="w-full px-5 py-4 bg-gray-50 border border-gray-100 rounded-2xl text-sm font-medium transition-all"></textarea>
                            </div>

                            <div class="space-y-2">
                                <label class="text-[11px] font-bold text-gray-400 uppercase tracking-widest ml-1">Jumlah Stok (pcs)</label>
                                <div class="relative">
