...
<div style="max-width: 860px;">
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-title"><i class="fas fa-plus-circle" style="color:#dc2626;margin-right:8px;"></i>Form Tambah Produk</div>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div style="border:2px dashed #e2e8f0;border-radius:12px;padding:24px;text-align:center;transition:border-color 0.2s;" id="drop-zone">
                        <div id="upload-placeholder">
                            <i class="fas fa-cloud-upload-alt" style="font-size:32px;color:#94a3b8;margin-bottom:10px;"></i>
                            <p style="font-size:13px;color:#64748b;margin-bottom:8px;">Klik untuk upload atau drag & drop gambar</p>
                    ...
                    <button type="button" onclick="document.getElementById('image').click()" class="btn btn-outline btn-sm" style="margin-top:10px;">
