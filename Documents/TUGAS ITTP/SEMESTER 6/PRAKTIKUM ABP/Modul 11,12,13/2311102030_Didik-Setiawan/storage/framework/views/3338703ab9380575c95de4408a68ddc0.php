...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group" style="display: flex; gap: 1.5rem;">
                <div style="flex: 1;">
                    ...
                    <input class="form-control" type="number" id="price" name="price" value="<?php echo e(old('price')); ?>" required min="0">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div style="flex: 1;">
                    ...
                    <input class="form-control" type="number" id="stock" name="stock" value="<?php echo e(old('stock', 0)); ?>" required min="0">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\jjj\k\2311102030\resources\views/products/create.blade.php ENDPATH**/ ?>