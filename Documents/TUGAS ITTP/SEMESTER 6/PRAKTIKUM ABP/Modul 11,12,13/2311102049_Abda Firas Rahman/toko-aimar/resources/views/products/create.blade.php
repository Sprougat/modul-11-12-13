...
<head>
    <meta charset="UTF-8">
    <title>Tambah Produk - Toko Aimar</title>
                ...
                <div class="card bg-white p-4 p-md-5">
                    <form action="{{ route('products.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_produk" class="form-control" placeholder="Contoh: Keyboard Mechanical" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="deskripsi" class="form-control" rows="3" placeholder="Tambahkan keterangan produk..."></textarea>
                        </div>

                        <div class="d-flex justify-content-end gap-2 mt-5">
                            <a href="{{ route('products.index') }}" class="btn btn-light rounded-pill px-4 fw-medium">Batal</a>
                            <button type="submit" class="btn btn-primary rounded-pill px-5 fw-medium shadow-sm">Simpan Produk</button>
                        </div>
                    </form>
                </div>
            </div>
